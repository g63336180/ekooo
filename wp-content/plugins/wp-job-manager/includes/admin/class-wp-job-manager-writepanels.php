...
<div id="location_info">根据地址获取经纬度：</div><div id="form_area">点击选择地点：</div><br>
地图缩放比例等级：<span id="map_level"></span><br>
<div id="allmap" style="height:500px; width:100%;"></div><script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=BrROQptLxvqmnN5UG505lUNo1hMAiFd9"></script>
...
//    }
	...
	map.addEventListener("click",function(e){
	    var tip_info = '经度(long)：'+ e.point.lng;
	    tip_info += ' ; 维度(lat)：' + e.point.lat;
	    
	    document.getElementById("form_area").innerHTML = "点击获取经纬度：" + tip_info;
	    jQuery("#map_level").html(map.getZoom());
    });
