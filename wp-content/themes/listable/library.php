...
<body>
	...
	<div id="tagnav" class="weui-navigator weui-navigator-wrapper">
		<ul class="weui-navigator-list">
			...
			<li class="weui-state-active"><a href="http://www.weartmap.com/library/">图书馆</a>
			</li>
   ...
   <div class="weui-panel weui-panel_access zixun_list">
        ...
        <div class="weui-panel__hd">图书馆相关文章列表</div>
<?php
$postslist = get_posts('category=140&numberposts=100&order=ASC&orderby=title');
