...
<body>
	...
	<div id="tagnav" class="weui-navigator weui-navigator-wrapper">
		<ul class="weui-navigator-list">
			...
			<li class="weui-state-active"><a href="http://www.weartmap.com/train/">培训</a>
			</li>
   ...
   <div class="weui-panel weui-panel_access zixun_list">
        ...
        <div class="weui-panel__hd">培训相关文章列表</div>
<?php
$postslist = get_posts('category=143&numberposts=100&order=ASC&orderby=title');
